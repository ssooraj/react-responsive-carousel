...
var Carousel = /*#__PURE__*/function (_React$Component) {
  ...
  function Carousel(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onClickNext", function () {
      let incrementInterval =  _this.props.slidesCount ? _this.props.slidesCount : 1;
      _this.increment(incrementInterval, false);
    });

    _defineProperty(_assertThisInitialized(_this), "onClickPrev", function () {
      let decrementInterval =  _this.props.slidesCount ? _this.props.slidesCount : 1;
      _this.decrement(decrementInterval, false);
    });
